...
data = pd.read_csv(r"random-forest-predictor\src\data\housing.csv")
data2 = pd.read_csv(r"random-forest-predictor\src\data\economic_data_2020_2023.csv")
...
forest = RandomForest(n_trees=300, max_depth=100)
forest.fit(X, y)
